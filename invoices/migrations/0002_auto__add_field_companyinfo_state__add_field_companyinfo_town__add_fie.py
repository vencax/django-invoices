...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyInfo.state'
        db.add_column('invoices_companyinfo', 'state',
                      self.gf('django.db.models.fields.CharField')(default='CZE', max_length=3),
                      keep_default=False)

        # Adding field 'CompanyInfo.town'
        db.add_column('invoices_companyinfo', 'town',
                      self.gf('django.db.models.fields.CharField')(default='nowhere', max_length=32),
                      keep_default=False)

        # Adding field 'CompanyInfo.address'
        db.add_column('invoices_companyinfo', 'address',
                      self.gf('django.db.models.fields.CharField')(default='nowhere', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyInfo.state'
        db.delete_column('invoices_companyinfo', 'state')

        # Deleting field 'CompanyInfo.town'
        db.delete_column('invoices_companyinfo', 'town')

        # Deleting field 'CompanyInfo.address'
        db.delete_column('invoices_companyinfo', 'address')
